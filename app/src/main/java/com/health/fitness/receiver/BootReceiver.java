package com.health.fitness.receiver;
...
import com.health.fitness.alarm.alarmmanagerdemo.NotificationPublisher;
...
public class BootReceiver extends BroadcastReceiver {
    ...
    private PendingIntent getPendingIntent() {
        Intent intent = new Intent("com.nilam.healthcare.alarmmanagerdemo.NOTIFY_ACTION");
