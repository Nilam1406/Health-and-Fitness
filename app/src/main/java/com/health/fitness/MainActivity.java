...
import com.health.fitness.fragment.Fragment_Calculate;
import com.health.fitness.fragment.Fragment_Reminder;
import com.health.fitness.fragment.Fragment_Walk_and_Step;
import com.health.fitness.fragment.Fragment_Workout;
import com.health.fitness.fragment.MainFragment;
...
//        MainActivity mainActivity = null;
    ...
    public boolean onNavigationItemSelected(MenuItem menuItem) {
        ...
        if (itemId == R.id.nav_rateus) {
            ...
            sb3.append("Best Free HealthCare app download now.\n Thnak You!\n  https://play.google.com/store/apps/details?id=" + getPackageName());
        ...
        }else  if(itemId == R.id.nav_privacy)
        {
            ...
            Uri uri = Uri.parse("https://docs.google.com/document/d/1-hzL5GdtUNXt2ubOz6nJiGYHuDORSXT-o5e0HxlwnUE/edit");
