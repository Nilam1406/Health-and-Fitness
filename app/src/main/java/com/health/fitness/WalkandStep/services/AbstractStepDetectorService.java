...
package com.health.fitness.WalkandStep.services;
...
import com.health.fitness.WalkandStep.activities.TrainingActivity;
import com.health.fitness.WalkandStep.models.StepCount;
import com.health.fitness.WalkandStep.persistence.StepCountPersistenceHelper;
import com.health.fitness.WalkandStep.persistence.TrainingPersistenceHelper;
import com.health.fitness.WalkandStep.persistence.WalkingModePersistenceHelper;
import com.health.fitness.WalkandStep.utils.StepDetectionServiceHelper;
import com.health.fitness.WalkandStep.utils.UnitHelper;
...
public abstract class AbstractStepDetectorService extends IntentService implements SensorEventListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String BROADCAST_ACTION_STEPS_DETECTED = "com.nilam.healthcare.STEPS_DETECTED";

    public static final String EXTENDED_DATA_NEW_STEPS = "com.nilam.healthcare.NEW_STEPS";

    public static final String EXTENDED_DATA_TOTAL_STEPS = "com.nilam.healthcare.TOTAL_STEPS";
