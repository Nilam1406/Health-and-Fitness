...
public class MovementSpeedService extends IntentService implements LocationListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String BROADCAST_ACTION_SPEED_CHANGED = "com.nilam.healthcare.SPEED_CHANGED";


    public static final String EXTENDED_DATA_CURRENT_SPEED = "com.nilam.healthcare.CURRENT_SPEED";
